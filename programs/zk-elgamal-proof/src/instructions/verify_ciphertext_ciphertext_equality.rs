use crate::{
    ...
    CIPHERTEXT_CIPHERTEXT_EQUALITY_PROOF_FULL_LEN, UNINIT_BYTE,
};
...
create_instruction_struct!(
    ...
    DOC_AUX = "A ciphertext-ciphertext equality proof certifies that two ElGamal ciphertexts encrypt the same message.",
